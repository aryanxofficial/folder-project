...
(function(){
    ...
    function loadFoldersFromStorage(){
        ...
        if(!!fjson){ // !! checks for every empty case..gives false for -undefined,empty,null,length=0..
            //jb kuch hoga actually tabhil true aayega vrna false
            folders = JSON.parse(fjson); //local storage mei pada string data object mei convert krdeta hai
